...
class Pipeline:
    ...
    def run(self, config):
        ...
        logger.info("Filtrando dataframe cujo o pagamento foi recusado mesmo sendo legitimos")
        ...
        logger.info("Fazendo a junção dos dataframes pedidos e pagamento")
        ...
        logger.info("Selecionando colunas")
        ...
        logger.info("Filtrando e ordenando dados de 2025 ")
